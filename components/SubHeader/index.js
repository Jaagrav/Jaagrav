  ...
  return (
    <div className="relative px-10 md:px-32 mx-auto skew">
      <div className="max-w-screen-xl mx-auto -translate-y-1/4">
        <h1 className="z-0 text-border text-[6rem] md:text-[7rem] whitespace-nowrap opacity-10 translate-y-1/2">
          {title}
        </h1>
        <img
          className="z-0 absolute m-auto top-0 bottom-0 left-0 -translate-x-1/2 max-w-none w-[50rem] md:w-[75rem] dark:opacity-60"
